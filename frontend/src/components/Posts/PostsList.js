            ...
            <div class="flex flex-wrap -mx-3">
              <div class="mb-8 lg:mb-0 w-full lg:w-1/4 px-3">
                <div class="py-4 px-6 bg-gray-600 shadow rounded">
                  ...
                  <ul>
                     {catLoading ?  <LoadingComponent/> : catAppErr || catServerErr ? <h1 className="text-yellow-400 text-lg text-center">{catServerErr} {catAppErr}</h1> : categoryList?.length <= 0 ? <h1 className="text-yellow-400 text-lg text-center">No Category Found</h1>: categoryList?.map((category) => (
                      <li>
...
{/* { Posts go here} */}
                { loading ? <LoadingComponent /> : appErr || serverErr ? <h1 className="text-yellow-400 text-lg text-center">{serverErr} {appErr}</h1> : postLists?.length <= 0 ? <h1 className="text-yellow-400 text-lg text-center">No Post Found</h1> : postLists?.map((post) => (
